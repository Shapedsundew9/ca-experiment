...
| `FIG-DIAG-008a` | [`fig_diag_008a_bistable_latching.py`](fig_diag_008a_bistable_latching.py) | `docs/research/assets/fig-diag-008a-bistable-latching.svg` | [`DIAG-2026-008a.md`](../../docs/research/diagnostics/DIAG-2026-008a.md) | Dual-panel bistable dynamic bit retention accuracy across conditions ($1.000$ vs $0.500$) and background noise resilience under critical percolation $\epsilon \in [0.00, 0.05]$. |
| `FIG-HYP-009` | [`fig_hyp_009_dfa_attractor.py`](fig_hyp_009_dfa_attractor.py) | `docs/research/assets/fig-hyp-009-dfa-attractor.svg` | [`HYP-2026-009.md`](../../docs/research/hypotheses/HYP-2026-009.md) | Dual-panel coupled resonant attractor basins for DFA sequence tracking: 2-state parity circuit topology and discrete phase space transition manifold. |
| `FIG-DIAG-009a` | [`fig_diag_009a_finite_state_automata.py`](fig_diag_009a_finite_state_automata.py) | `docs/research/assets/fig-diag-009a-finite-state-automata.svg` | [`DIAG-2026-009a.md`](../../docs/research/diagnostics/DIAG-2026-009a.md) | Dual-panel DFA sequence classification accuracy across conditions ($1.000$ vs $0.500$) and channel noise percolation resilience under $\epsilon \in [0.00, 0.05]$. |
| `FIG-HYP-010` | [`fig_hyp_010_pushdown_memory.py`](fig_hyp_010_pushdown_memory.py) | `docs/research/assets/fig-hyp-010-pushdown-memory.svg` | [`HYP-2026-010.md`](../../docs/research/hypotheses/HYP-2026-010.md) | Dual-panel cascaded dynamical stack substrate for pushdown automata: modular stack ladder circuit topology and LIFO state transition dynamics for Dyck languages. |
| `FIG-DIAG-010a` | [`fig_diag_010a_pushdown_memory.py`](fig_diag_010a_pushdown_memory.py) | `docs/research/assets/fig-diag-010a-pushdown-memory.svg` | [`DIAG-2026-010a.md`](../../docs/research/diagnostics/DIAG-2026-010a.md) | Tri-panel empirical evaluation of pushdown memory: depth scaling vs FSM baseline ($d = 4.83, p < 10^{-6}$), 100% violation rejection fidelity, and noise percolation resilience under $\epsilon \in [0.00, 0.05]$. |
| `FIG-HYP-011` | [`fig_hyp_011_associative_retrieval.py`](fig_hyp_011_associative_retrieval.py) | `docs/research/assets/fig-hyp-011-associative-retrieval.svg` | [`HYP-2026-011.md`](../../docs/research/hypotheses/HYP-2026-011.md) | Dual-panel associative key-value retrieval substrate: 16-slot addressable resonant array, write coincidence gating, distractor immunity, and needle-in-a-haystack trajectory. |
| `FIG-DIAG-011a` | [`fig_diag_011a_associative_retrieval.py`](fig_diag_011a_associative_retrieval.py) | `docs/research/assets/fig-diag-011a-associative-retrieval.svg` | [`DIAG-2026-011a.md`](../../docs/research/diagnostics/DIAG-2026-011a.md) | Tri-panel empirical evaluation of associative key-value retrieval: long context retention vs unindexed/unshielded controls ($d = 7.82, p < 10^{-40}$), noise percolation resilience, and distractor/mutex invariant compliance. |
